...
-----------------------------
- প্রতিটি রান আউটপুট সংরক্��ণ করে: `scans/<target>/<UTC-timestamp>/` (উদাহরণ: `scans/example.com/20260904T123456Z/`).
- প্রতিটি রান `scan.log` (সমস্ত টার্মিনাল আউটপুট) এবং nmap এর `-oA` আউটপুট ফাইল রাখে।

LICENSE
-------
এই রিপোটি SPDX-License-Identifier: MIT সহ MIT লাইসেন্সের অধীনে প্রকাশ করা হয়েছে। বিস্তারিত LICENSE ফাইলে দেখুন।
